...
import com.baha.kmfapp.Status
import com.baha.kmfapp.databinding.DialogShowInfoBinding
...
class ShowInfoDialog: DialogFragment() {
    ...
    private val viewModel: ShowInfoVM by lazy {
        ViewModelProvider(this).get(ShowInfoVM::class.java)
    }
